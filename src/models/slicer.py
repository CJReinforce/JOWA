...
class Slicer(nn.Module):
    ...
    def compute_slice(self, num_steps: int, prev_steps: int = 0) -> torch.LongTensor:
        ...
        return (indices[torch.logical_and(prev_steps <= indices, indices < total_steps)] - prev_steps).to(torch.long)
